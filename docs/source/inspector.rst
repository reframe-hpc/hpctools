...
through writing ReFrame tests to analyze our `code <started.html>`_ with this
tool. Looking into the :class:`Class <reframechecks.intel.intel_inspector>`
...
.. literalinclude:: ../../reframechecks/intel/intel_inspector.res
  :lines: 1-9
  :emphasize-lines: 9
