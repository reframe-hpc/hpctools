...
# jg: ori=/apps/common/UES/sandbox/jgp/VENV/myvenv_pilatus/lib/python3.8/site-packages/termgraph/termgraph.py
# jg: added leged next to bar
# jg: ./termgraph.py ./in --color {red,blue,green,magenta,yellow,black,cyan,red} --space-between --suffix ' sec'
